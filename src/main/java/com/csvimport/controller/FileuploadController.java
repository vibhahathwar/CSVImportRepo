...
public class FileuploadController {
	...
	public String doUpload(@ModelAttribute("formupload") FileUpload fileupload, BindingResult result, RedirectAttributes redirect) throws IOException{
		...
		if(result.hasErrors()){
			...
			redirect.addFlashAttribute("fileNames", uploadAndImportDb(fileupload));
